 ...
 * {@link onVideoViewInteractionListener} interface
...
public class VideoListFragment extends Fragment {
    ...
    private onVideoViewInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onVideoViewInteractionListener(uri);
        }
    }
     ...
     */
    public interface onVideoViewInteractionListener {
